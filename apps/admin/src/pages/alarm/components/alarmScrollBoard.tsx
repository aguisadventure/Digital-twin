      ...
      <div className="flex flex-col" style={{ height: '370px' }}>
        ...
        <div className="flex pb-5" style={{ height: '40px' }}>
          <div className="justify-self-center self-center">
            <span>告警类型</span>
            <span className="ml-5 tag-box rounded-md">A</span>
            <span className="ml-5 tag-box rounded-md">B</span>
            <span className="ml-5 tag-box rounded-md">C</span>
            <span className="ml-5 tag-box rounded-md">D</span>
          </div>
